            ...
            <form onSubmit={handleLogin}>
                <div className="flex justify-center">
                    <div className="border-2 p-3 my-4 rounded-2xl bg-amber-200">
                        <h1 className="font-extrabold text-4xl text-blue-600 border-b-4 text-center">Login</h1>
                        ...
                        <div className="flex justify-center">
                            <button className="border-2 bg-green-500 font-bold text-2xl rounded-2xl p-1.5 text-amber-950 cursor-pointer" type="submit">{isLoading ? "Loading" : "Login"}</button>
                        </div>
                        <div className="flex justify-center">
                            <label htmlFor="sign">Don't have an account? <span className="text-blue-600">SignUp</span></label>
                        </div>
                    </div>
                </div>
            </form>
