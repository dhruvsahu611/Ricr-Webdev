  ...
  return (
    <>
      <div className='flex gap-10'>
        ...
        <button className='border px-5 py-2 bg-amber-500 text-amber-100 hover:cursor-pointer rounded-xl' onClick={()=>setIsEditProfileModalOpen(true)}>Edit Profile</button>
      </div>
